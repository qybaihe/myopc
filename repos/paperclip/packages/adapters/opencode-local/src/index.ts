...
export const label = "MyOPC Code Engine";
...
export const DEFAULT_OPENCODE_LOCAL_MODEL = "anthropic/MiniMax-M3";
...
export const models: Array<{ id: string; label: string }> = [
  { id: DEFAULT_OPENCODE_LOCAL_MODEL, label: "MyOPC 无限 Token · MiniMax M3" },
];
...
export const modelProfiles: AdapterModelProfileDefinition[] = [
  {
    key: "cheap",
    label: "Unlimited",
    description: "Use the same MiniMax M3 lane for lightweight and primary MyOPC coding tasks.",
    adapterConfig: {
...
Use when:
- You want MyOPC to run OpenCode locally as the agent runtime
...
- MyOPC requires an explicit \`model\` value for \`opencode_local\` agents.
