...
export const help: Record<string, string> = {
  ...
  adapterType: "How this agent runs: MyOPC Code Engine, Claude, OpenClaw Gateway, spawned process, or generic HTTP webhook.",
  ...
  dangerouslyBypassSandbox: "Run the local coding engine without sandbox restrictions. Required for filesystem/network access.",
  search: "Enable web search capability during runs when the selected runtime supports it.",
  fastMode: "Enable the fast lane when the selected runtime supports it.",
  workspaceStrategy: "How MyOPC should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for issue-scoped isolated checkouts.",
  ...
  bootstrapPrompt: "Only sent when MyOPC starts a fresh session. Use this for stable setup guidance that should not be repeated on every heartbeat.",
  payloadTemplateJson: "Optional JSON merged into remote adapter request payloads before MyOPC adds its standard wake and workspace fields.",
          ...
          <div className="space-y-4 text-sm">
            <section className="space-y-1.5">
              ...
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                ...
                <li>{t("Hold Option and right-click the folder.")}</li>
            ...
            <section className="space-y-1.5">
              ...
              <ol className="list-decimal space-y-1 pl-5 text-muted-foreground">
                ...
                <li>{t("Hold Shift and right-click the folder.")}</li>
