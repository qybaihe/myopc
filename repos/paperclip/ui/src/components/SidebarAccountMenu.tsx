...
export function SidebarAccountMenu({
  ...
  const accountBadge = deploymentMode === "authenticated" ? t("Account") : t("Local");
          ...
          <div className="-mt-8 px-4 pb-4">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 pt-1">
                ...
                {version ? (
                  <p className="mt-1 text-xs text-muted-foreground">{t("Paperclip v{{version}}", { version })}</p>
                ) : null}
              </div>
            </div>
