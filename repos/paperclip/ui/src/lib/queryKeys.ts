export const queryKeys = {
  ...
  products: {
    ...
    analytics: (companyId: string, productId: string) => ["products", companyId, "analytics", productId] as const,
  },
  monitoring: {
    uptimeKuma: (companyId: string) => ["monitoring", companyId, "uptime-kuma"] as const,
  },
  knowledge: {
    companyList: (companyId: string) => ["knowledge", "company", companyId] as const,
    companyDoc: (companyId: string, docId: string) => ["knowledge", "company", companyId, docId] as const,
    projectList: (projectId: string) => ["knowledge", "project", projectId] as const,
    projectDoc: (projectId: string, docId: string) => ["knowledge", "project", projectId, docId] as const,
  },
  goals: {
  ...
  instance: {
    aiSettings: ["instance", "ai-settings"] as const,
