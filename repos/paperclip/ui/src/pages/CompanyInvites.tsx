...
import { HUMAN_COMPANY_MEMBERSHIP_ROLE_LABELS } from "@paperclipai/shared";
...
function humanRoleLabel(role: "owner" | "admin" | "operator" | "viewer" | null | undefined) {
  return role ? HUMAN_COMPANY_MEMBERSHIP_ROLE_LABELS[role] : null;
}
    ...
    <div className="max-w-5xl space-y-8">
      ...
      <section className="space-y-4 rounded-xl border border-border p-5">
        <div className="space-y-1">
          <h2 className="text-sm font-semibold">{t("Create invite")}</h2>
                ...
                <tbody>
                  {inviteHistory.map((invite) => (
                    <tr key={invite.id} className="border-b border-border last:border-b-0">
                      ...
                      <td className="px-5 py-3 align-top">{invite.humanRole ? t(humanRoleLabel(invite.humanRole) ?? invite.humanRole) : "—"}</td>
                      <td className="px-5 py-3 align-top">
