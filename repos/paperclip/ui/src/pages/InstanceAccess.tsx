...
function formatMembershipRole(role: string | null, t: (key: string, params?: Record<string, string | number>) => string) {
  return role ? t(role) : t("Unset");
}

function formatMembershipStatus(status: string, t: (key: string, params?: Record<string, string | number>) => string) {
            ...
            {(usersQuery.data ?? []).map((user) => (
              ...
              >
                ...
                <div className="mt-2 text-xs text-muted-foreground">
                  {t("{{count}} active company memberships", { count: user.activeCompanyMembershipCount })}
                </div>
              </button>
            ))}
          </div>
                    ...
                    >
                      <div>
                        ...
                        <div className="text-muted-foreground">
                          {formatMembershipRole(membership.membershipRole, t)} • {formatMembershipStatus(membership.status, t)}
                        </div>
                      </div>
