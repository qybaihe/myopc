          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-3">
              ...
              <Field
                ...
                hint={t("Accepted range: 1-{{count}} MiB.", { count: MAX_COMPANY_ATTACHMENT_MAX_MIB })}
              >
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-xs text-muted-foreground">{t("MiB")}</span>
                  </div>
                  {!attachmentMaxValid && (
                    <span className="text-xs text-destructive">
                      {t("Enter a whole number from 1 to {{count}}.", { count: MAX_COMPANY_ATTACHMENT_MAX_MIB })}
                    </span>
                  )}
                </div>
              </Field>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-md border border-border px-4 py-4">
          <p className="text-sm text-muted-foreground">
            ...
            <a href="/org" className="underline hover:text-foreground">{t("Org Chart")}</a> {t("page header.")}
          </p>
