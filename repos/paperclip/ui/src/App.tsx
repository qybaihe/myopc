...
import { InstanceAiSettings } from "./pages/InstanceAiSettings";
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="projects/:projectId/opencode" element={<ProjectDetail />} />
      ...
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="instance/settings" element={<Layout />}>
            ...
            <Route path="ai" element={<InstanceAiSettings />} />
          ...
          <Route path="opencode" element={<UnprefixedBoardRedirect />} />
          <Route path="monitoring" element={<UnprefixedBoardRedirect />} />
