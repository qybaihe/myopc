...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: {
    ...
    const colorScheme = props.forcedColorScheme ?? ((read(STORAGE_KEYS.COLOR_SCHEME) as ColorScheme | null) ?? "system")
    ...
    const onStorage = (e: StorageEvent) => {
      ...
      if (!props.forcedColorScheme && e.key === STORAGE_KEYS.COLOR_SCHEME && e.newValue) {
    ...
    onMount(() => {
      ...
      const savedScheme = props.forcedColorScheme ?? ((read(STORAGE_KEYS.COLOR_SCHEME) as ColorScheme | null) ?? "system")
    ...
    const setColorScheme = (scheme: ColorScheme) => {
      if (props.forcedColorScheme) {
        setStore("colorScheme", props.forcedColorScheme)
        setStore("mode", props.forcedColorScheme)
        return
      }
