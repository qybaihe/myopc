...
import { readEmbedConfig } from "@/utils/embed"
...
export default function Layout(props: ParentProps) {
  ...
  const embed = createMemo(() => readEmbedConfig(location.search))
  const hideEmbeddedSidebarChrome = createMemo(() => embed().enabled && embed().hideSidebar)
  ...
  createEffect(() => {
    if (!hideEmbeddedSidebarChrome()) return
  ...
  createEffect(() => {
    const sidebarWidth = hideEmbeddedSidebarChrome()
      ? 0
        ...
        <div class="flex-1 min-h-0 relative">
          <div class="size-full relative overflow-x-hidden">
            <nav
              ...
              classList={{
                "hidden xl:block": !hideEmbeddedSidebarChrome(),
            ...
            <Show when={!hideEmbeddedSidebarChrome() && layout.sidebar.opened()}>
              <div
            ...
            <Show when={!hideEmbeddedSidebarChrome()}>
              <div
            ...
            <div classList={{ "xl:hidden": true, hidden: hideEmbeddedSidebarChrome() }}>
              <div
                classList={{
            ...
            <div
              ...
              style={{
                "--main-left": hideEmbeddedSidebarChrome()
                  ? "0px"
                  : layout.sidebar.opened()
                    ? `${side()}px`
                    : "4rem",
            ...
            >
              <main
                classList={{
                  ...
                  "xl:border-l xl:rounded-tl-[12px]": !hideEmbeddedSidebarChrome(),
                }}
              >
            ...
            <div
              classList={{
                "hidden xl:flex absolute inset-y-0 left-16 z-30": !hideEmbeddedSidebarChrome(),
            ...
            <div
              classList={{
                "hidden xl:block pointer-events-none absolute inset-y-0 right-0 z-25 overflow-hidden": !hideEmbeddedSidebarChrome(),
