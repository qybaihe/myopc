...
export function Titlebar() {
  ...
  const hideEmbeddedSidebarChrome = createMemo(() => {
    const embed = readEmbedConfig(location.search)
    return embed.enabled && embed.hideSidebar
  })
      ...
      >
        ...
        >
          <Show when={mac()}>
            ...
            <div classList={{ "xl:hidden w-10 shrink-0 flex items-center justify-center": true, hidden: hideEmbeddedSidebarChrome() }}>
              <IconButton
                icon="menu"
                variant="ghost"
          ...
          <Show when={!mac()}>
            <div classList={{ "xl:hidden w-[48px] shrink-0 flex items-center justify-center": true, hidden: hideEmbeddedSidebarChrome() }}>
              <IconButton
                icon="menu"
                variant="ghost"
                class="titlebar-icon rounded-md"
